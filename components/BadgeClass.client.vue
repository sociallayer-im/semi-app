<template>
  <UModal :title="i18n.text['Badge Class Details']">
    <div
      class="flex flex-col items-center justify-center bg-muted rounded-lg p-4 overflow-hidden gap-2"
    >
      <div class="flex items-center justify-center bg-gray-500 rounded-full overflow-hidden">
        <img :src="badgeClass.metadata.class_image_url" class="w-16 h-16 rounded-full" alt="" />
      </div>
    ...
    <template #body>
      <div class="flex flex-col items-center justify-center gap-4">
        ...
        >
          <img
            :src="badgeClass.metadata.class_image_url"
            alt="badge image"
