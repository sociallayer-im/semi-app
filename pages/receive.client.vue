      ...
      <div class="w-full flex flex-col items-center justify-center">
        ...
        <div class="text-center">
          <div class="text-gray-400 text-sm mb-2">
            {{ i18n.text["Scan QR code to receive assets"] }}
          </div>
            ...
            <div class="flex items-start gap-3">
              <div class="text-sm text-gray-600">
                <p class="font-medium mb-1 flex items-center gap-2">
                  <UIcon name="ci:info" class="text-blue-500 text-xl" />
                  {{ i18n.text["Security Tip"] }}
                </p>
                <p>
                  {{
                    i18n.text[
                      "Please ensure you only send {chainName} assets to this address. Sending other assets may result in asset loss."
                    ].replace("{chainName}", useChain.chain.name)
                  }}
                </p>
              </div>
            </div>
