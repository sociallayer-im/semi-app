<template>
    ...
    <div class="mx-aut p-3">
        <div class="text-2xl font-bold text-center mb-4">Mint Profile</div>
        <UForm :state="mintParams" @submit="handleMint" class="w-full flex flex-col gap-4">
            ...
            <UFormField name="isDefault" label="Is Default">
                <USwitch v-model="mintParams.isDefault" />
            </UFormField>
...
const handleMint = async () => {
    ...
    try {
        ...
        const txHash = await registry.createProfile({
            ...
            params: {
                ...
                isDefault: mintParams.value.isDefault
            },
            account: account,
            clientConfig
        })
