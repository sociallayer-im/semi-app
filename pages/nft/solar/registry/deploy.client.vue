    ...
    <div class="flex flex-col container-size rounded-xl bg-[var(--ui-bg)] shadow-lg p-4 "
        ...
        <div class="mx-aut p-3">
            ...
            <UForm :state="deployParams" @submit="handleDeploy" class="w-full flex flex-col gap-4">
                ...
                <UFormField name="uri" label="URI">
                    <UInput variant="subtle" size="md" class="w-full" v-model="deployParams.uri" disabled />
                </UFormField>
...
const handleDeploy = async () => {
    ...
    try {
        ...
        const receipt = await deploy.deployRegistry({
            params: deployParams.value,
            account: account,
            clientConfig
        })
        console.log(receipt)
